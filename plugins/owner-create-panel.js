...
let handler = async (m, { conn, args, text, usedPrefix: _p, command, isROwner }) => {
    ...
    //Manage panel
    const domain = "https://yukinesia.adwxd.icu" // Domain
const apikey = "ptla_0tCWbEEDgEX4cIDbIVbvrdiGCGDf9sEQ2W8RGFp7XRj" // Apikey
const c_apikey = "ptlc_pc2W1mfRus60q5Axp1fAO03YXzSaBfCmdOTt3URl5Wh" // c Apikey

    const webPage = "https://yukinesia.adwxd.icu" // Web Page
